...
/**
 * This is for the data of com.example.capstoneapplication.Radium
 */
class Radium : Elements() {
    override val elementname: String?
         ...
         */
        get() = "com.example.capstoneapplication.Radium"
    ...
    public override fun getcommonuses(): String? {
        return "Radiography, Medical com.example.capstoneapplication.Radon Production"
    }
